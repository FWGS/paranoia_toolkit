...
extern "C" void EXPORT IN_ClientMoveEvent( float forwardmove, float sidemove );
extern "C" void EXPORT IN_ClientLookEvent( float relyaw, float relpitch );
...
extern "C" void EXPORT IN_MouseEvent( int mstate )
{
...
extern "C" void EXPORT IN_ClearStates( void )
{
	//gEngfuncs.Con_Printf( "IN_ClearStates\n" );
}

extern "C" void EXPORT IN_ActivateMouse( void )
{
	//gEngfuncs.Con_Printf( "IN_ActivateMouse\n" );
}

extern "C" void EXPORT IN_DeactivateMouse( void )
{
	//gEngfuncs.Con_Printf( "IN_DeactivateMouse\n" );
}

extern "C" void EXPORT IN_Accumulate( void )
{
