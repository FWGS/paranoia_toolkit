...
public:
	...
	int MsgFunc_DelParticle(const char *pszName, int iSize, void *pbuf ); // buz
};
...
public:
	...
	int  _cdecl MsgFunc_PlayMP3( const char *pszName, int iSize, void *pbuf ); // buz
